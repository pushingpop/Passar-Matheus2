<template lang="html">
  <div class="nameField">
    ...
    <div class="control">
      <label class="">Sigla do Orgão: </label>
      <input v-model="form.siglaInst" class="input" type="text" placeholder="Ex: ABNT">
    </div>

    <div class="control req">
      <label class="req">Nome do Orgão: </label>
      <input v-model="form.nomeOrgao" class="input" type="text" placeholder="Ex: Associação Brasileira de Normas Técnicas">
    </div>

    <div class="control req">
      <label class="req">Nome e Número da Norma: </label>
      <input v-model="form.nomeNorma" class="input" type="text" placeholder="Ex: NBR 6120">
    </div>
    ...
    <div class="control req">
      <label class="req">Nº Edição: </label>
      <input v-model="form.numero" class="input" type="text" placeholder="Ex: 3">
    </div>
  ...
  methods:{
    ...
    changeQntCap(){
      ...
      chamarDados(){
        ...
        if(this.form.nomeNorma != ''){
          this.output += this.form.nomeNorma + ": ";
        }
        if(this.form.titulo != ''){
